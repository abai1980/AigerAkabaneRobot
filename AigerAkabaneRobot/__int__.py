...
from AigerAkabaneRobot.config import get_bool_key, get_int_key, get_list_key, get_str_key
from AigerAkabaneRobot.services.telethon import tbot
from AigerAkabaneRobot.utils.logger import log
from AigerAkabaneRobot.versions import AIGER_VERSION

log.info("----------------------")
log.info("|      AIGER AKABANE     |")
log.info("----------------------")
log.info("Version: " + AIGER_VERSION)

...
from AigerAkabaneRobot import TOKEN, bot, dp
from AigerAkabaneRobot.config import get_bool_key, get_list_key
from AigerAkabaneRobot.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
...
if get_bool_key("LOAD_MODULES"):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("AigerAkabaneRobot.modules." + module_name)
...
import_module("AigerAkabaneRobot.modules.pm_menu")
# Import misc stuff
import_module("AigerAkabaneRobot.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("AigerAkabaneRobot.utils.sentry")

...
from AigerAkabaneRobot import OPERATORS, bot
from AigerAkabaneRobot.services.mongo import db
from AigerAkabaneRobot.services.redis import bredis
    ...
    for entity in entities:
        ...
        if text in entity.get_text(message.text):
            if entity.type == "mention":
                # This one entity is comes with mention by username, like @AigerAkabaneRobot
